...
* Migration landed in commit `4993feb` (`update trellis from 0.3.10 to 0.4.0`).
* Follow-up Codex skill updates landed in commit `1e6fc66` (`feat(trellis): update skills for codex`).
* Smoke-tested workflow commands:
